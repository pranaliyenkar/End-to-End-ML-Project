...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try :
            ...
            logging.info(f"Numerical std scaling completed:{numerical_columns}")
            logging.info(f"Categorical std scaling completed:{categorical_columns}")
    ...
    def initiate_data_transformation(self,train_path, test_path):
        try:
            ...
            preprecessor_obj=self.get_data_transformer_object()
            ...
            logging.info("saved preporocessing obj")
            logging.info(f"path :{self.data_transformation_config.preprocessor_obj_file_path}")

            save_object ( file_path=self.data_transformation_config.preprocessor_obj_file_path,obj=preprecessor_obj)
